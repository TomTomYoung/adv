...
export function collections(entry,value){
 ...
 case 'cells':return [collection('maps','セルの配置図','cellmap'),collection('presets','セル種','cell'),collection('events','セル進入イベント','cellEvent'),collection('scripts','セルの処理','script')];
...
export const editableScope={
 ...
 cells:'セル種、セル配置、地点ごとの上書き、セル進入イベントと処理。',
