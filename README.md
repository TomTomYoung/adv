...
最初は掲示板で「帰らない灯番」を受注し、その場で「迷宮の入口へ向かう（篝火の迷宮）」を押します。広場へ戻る必要はありません。W/Sで前後移動、A/Dで方向転換します。新人・老人のイベントは指定セルを踏むと自動開始し、Eで壁灯などの足元・正面を調べます。ボタンでも全操作ができます。右のメインクエスト欄に次の目的地が出ます。
