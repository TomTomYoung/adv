2026-09-16 / v1.10.0：町7か所の背景・人物表示と階層移動、q002の地下水道・標本室・保険審査所の往復、カタログの実配置索引を追加しました。[ワールド接続仕様](doc/WORLD_LOCATIONS.md)。

1.14.0：地下水道を水密扉付きの小さな2D区画へ再構成し、q001〜q030のダンジョン接続を統一しました。[仕様と退避方針](doc/CONNECTED_2D_MAPS.md)。

2026-09-16 / v1.9.0：q001を火と恐怖の物語へ改稿し、フロア水没0〜10、3D区域への水没操作、装備個体の塩とソルトイーターを実装しました。読込できないセーブは新規開始します。[改訂内容](doc/DUNGEON_REVISION_1_9.md)。
...
[改稿全文](doc/QUEST_CATALOG.md#q001-帰らない灯番) ／ [人物一覧・画像](doc/CHARACTERS.md) ／ [モデル・保存互換性](doc/SCENARIO_MODEL_V11.md)
