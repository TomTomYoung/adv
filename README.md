...
- 200件の日本語クエスト、559場面・629結末。救助後の再捜索、作業順による損失、実験、交渉、待機、帰還後の応答など、依頼ごとに進行を定義。
...
1.0.0〜1.3.1の記録は1.3.2へ移行します。進行中の旧依頼はその続きから完了でき、新たに受注した依頼は新しい進行になります。転職・成長・装備・継続位置を保持し、1.3.1の戦績も引き継ぎます。それより古い版で記録されていなかった戦績は推測しません。
