...
try{
 ...
 await page.goto(base+'config/map.html?dungeon=kagaribi');await page.locator('.palette-choice').first().waitFor();assert.equal(await page.locator('.palette-choice').count(),24);
