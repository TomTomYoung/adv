...
actors.push('## 編集と保存','','人物・初期能力・肖像の正本は authoring/entities.json、職業は authoring/jobs.json です。職業別の成長と使用可能な探索特技は[JOB_SYSTEM.md](JOB_SYSTEM.md)、保存方針は[SPEC.md](SPEC.md)を参照してください。1.9.0は旧内容版から移行せず、読込エラー時に新規開始します。');await fs.writeFile(path.join(folder,'COMPANION_CATALOG.md'),actors.join('\n')+'\n');
