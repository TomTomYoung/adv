...
export async function buildWorld(root){
  ...
  game.world={version:1,townRoot:'hikarigaeri_square'};game.version='1.19.0';game.inspectionVersion=1;game.fieldEventVersion=1;game.files.databases.locations='data/locations.json';
