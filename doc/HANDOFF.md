...
確認日: 2026-09-23。作品版1.18.0。起点はPR #38まで反映済みのmaster `d96720a`。作業ブランチは `feat/json-config-editors`。225原稿JSONをconfigへ移し、対応する編集HTMLと検証・全JSONコピー出力を実装しました。ゲーム配布データ・内容版・保存仕様は変更していません。
