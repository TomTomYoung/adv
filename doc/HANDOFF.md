...
確認日: 2026-09-19。作品版1.15.0。起点はPR #31反映済みのmaster `179eb4d`。作業ブランチは `feat/scripted-cast-fixed-dialog`。固定メッセージ領域と実寸ページ分割、選択肢の枠内スクロール、シナリオ指定の立ち絵演出を実装しました。関連docとq001の原稿・配布JSONを更新しました。内容版の異なるセーブは従来方針どおり新規開始します。
