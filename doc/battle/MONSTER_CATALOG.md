...
作品版1.20.0。配布中の敵は59定義、遭遇編成は82定義、敵が参照する画像ファイルは25点です。敵の定義数と、独自の外見を持つ魔物の数は同じではありません。
...
戦闘開始命令：21スクリプト。q002.v11.entry・q004.decision・q004.review・q004.flow.entry・q004.v11.entry・q005.decision ほか15件。全配置の照合は[イベント一覧](../scenarios/EVENT_CATALOG.md)を参照してください。
