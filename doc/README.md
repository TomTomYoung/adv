...
更新日: 2026-09-23。対象は作品版1.18.0。便利調べる・任意調べるとエッジ上のたいまつを追加しました。通常は33件の2Dマップを読み込み、シナリオ本文と選択肢をメッセージウィンドウへ統合しています。[2D区画接続と水密扉](CONNECTED_2D_MAPS.md)、[現在の状態](CURRENT_STATUS.md)を確認してください。
