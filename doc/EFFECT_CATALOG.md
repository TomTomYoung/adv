...
確認日: 2026-09-14。作品版1.8.0、表示効果24種。
...
現行の全458テストに表示効果の検証を含みます。演出の有無で同じ入力・seedから同じ保存状態になること、持続レイヤー、予約取消し、SE重複防止、不正な定義の拒否を検査しています。最新の全体検証は[PROGRESS.md](PROGRESS.md)を参照してください。
